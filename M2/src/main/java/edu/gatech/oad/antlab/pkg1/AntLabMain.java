 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Nick Angalet");
		  toPrint += p1.toString("nangalet3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Duncan Chance");
		  toPrint += p2.toString("dchance3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Jeffrey Lin");
		  toPrint += p3.toString("jlin329");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Ryan Murphy");
                  toPrint += p4.toString("rmurphy45");
